...
from scripts.data_loader.dataloader import MyDataset
...
def main(
    ...
    #train_dataset = MyDataSet(filename=train_csv, path="data/", q = forecast_window)
    train_dataset = MyDataset(q=forecast_window)
...
#    test_dataset = SensorDataset(csv_name = test_csv, root_dir = "Data/", training_length = training_length, forecast_window = forecast_window)
    test_dataset = MyDataset(q=forecast_window)
